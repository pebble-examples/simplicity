...
static void prv_main_window_load(Window *window) {
  ...
  layer_add_child(s_window_layer, s_line_layer);
...
static void prv_init() {
  ...
  prv_handle_minute_tick(t, MINUTE_UNIT);
}
